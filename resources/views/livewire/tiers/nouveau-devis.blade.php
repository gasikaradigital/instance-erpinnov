        ...
        <div class="card">
            <div class="card-body">
                <form id="newDraftForm"  wire:submit.prevent="submit">
                    ...
                    <h3 class="fs-5 mb-3 text-secondary"><i class="fas fa-user-tie me-2"></i>Informations client</h3>
                    <div class="row mb-4">
                    ...
                    <!-- Section 2: Dates -->
                    <h3 class="fs-5 mb-3 text-secondary"><i class="fas fa-calendar-alt me-2"></i>Dates et délais</h3>
                    <div class="row mb-4">
                        <div class="col-md-4 mb-3">
                    ...
                    <h3 class="fs-5 mb-3 text-secondary"><i class="fas fa-money-check-alt me-2"></i>Conditions de
                        règlement</h3>
                    <div class="row mb-4">
                        <div class="col-md-4 mb-3">

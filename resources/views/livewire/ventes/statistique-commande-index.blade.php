...
<div class="container-flux p-6">
    <h4 class="fw-bold py-3 mb-4">Statistiques des commandes</h4>
        ...
        <div class="col-12 col-xl-5">
            ...
            <div class="row">
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Nombre de commandes par mois</h5>
                        </div>
                        <div class="card-body ">
                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Montant total de commandes par mois (HT)</h5>
                        </div>
                        <div class="card-body">
                            <div class="chart-legend mb-2 d-flex justify-content-center align-items-center">
                                <span class="badge bg-primary me-2">2023</span>

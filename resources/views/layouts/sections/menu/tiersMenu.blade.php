...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <ul class="menu-inner py-1">
        ...
        <li
            class="menu-item {{ in_array($currentRouteName, ['tiers-dashboard', 'create-tiers', 'tiers', 'tag-customer']) ? 'active open' : '' }}">
        ...
        <li
            class="menu-item {{ in_array($currentRouteName, ['contacts-dashboard', 'create-contact', 'contact', 'tag-contact']) ? 'active open' : '' }}">
        ...
        <li
            class="menu-item {{ in_array($currentRouteName, ['devis-dashboard', 'create-devis', 'liste-devis']) ? 'active open' : '' }}">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        dashboardLinks.forEach(function(link) {
            link.addEventListener('click', function(event) {
                ...
                if (event.target === this || event.target.parentElement === this || event.target
